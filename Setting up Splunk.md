...
## **Objective**  
The objective of setting up Splunk is for the purpose of analyzing and investigating the BotsV3 dataset.
Upon completion you will have Splunk fully installed and configured on an Ubuntu machine, ready to ingest, search, and analyze the BotsV3 dataset for security-related insights.

---

## **Lab Setup**  
### **Requirements**  
- **System:** Ubuntu 22.04 / 20.04 Server 
- **Tools Required:**  
...
<img width="1339" height="946" alt="image" src="https://github.com/user-attachments/assets/e55b284d-9b69-4ccb-a612-3316dd05e6e9" />
